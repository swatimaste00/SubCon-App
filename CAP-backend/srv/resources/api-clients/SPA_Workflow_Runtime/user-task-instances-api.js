...
exports.UserTaskInstancesApi = {
     ...
     */
    getV1TaskInstances: (queryParameters, headerParameters) => new openapi_1.OpenApiRequestBuilder('get', '/v1/task-instances', {
        queryParameters,
        headerParameters
    }),
    /**
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    getV1TaskInstancesByTaskInstanceId: (taskInstanceId, queryParameters, headerParameters) => new openapi_1.OpenApiRequestBuilder('get', '/v1/task-instances/{taskInstanceId}', {
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    getV1TaskInstancesAttributesByTaskInstanceId: (taskInstanceId, headerParameters) => new openapi_1.OpenApiRequestBuilder('get', '/v1/task-instances/{taskInstanceId}/attributes', {
        pathParameters: { taskInstanceId },
        headerParameters
    }),
    /**
