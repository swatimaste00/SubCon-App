...
export declare const WorkflowInstancesApi: {
  ...
  ) => OpenApiRequestBuilder<WorkflowInstance[]>;
  /**
  ...
  ) => OpenApiRequestBuilder<CustomAttribute[]>;
  /**
  ...
  getV1WorkflowInstancesContextByWorkflowInstanceId: (
    workflowInstanceId: string
  ) => OpenApiRequestBuilder<Record<string, any>>;
  /**
  ...
  getV1WorkflowInstancesErrorMessagesByWorkflowInstanceId: (
    workflowInstanceId: string
  ) => OpenApiRequestBuilder<WorkflowInstanceErrorMessage[]>;
  /**
  ...
  ) => OpenApiRequestBuilder<WorkflowInstanceExecutionLog[]>;
};
