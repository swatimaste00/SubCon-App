...
exports.WorkflowInstancesApi = {
     ...
     * @param headerParameters - Object containing the following keys: Accept-Language.
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    getV1WorkflowInstances: (queryParameters, headerParameters) => new openapi_1.OpenApiRequestBuilder('get', '/v1/workflow-instances', {
        queryParameters,
        headerParameters
    }),
    /**
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    createV1WorkflowInstances: (body, headerParameters) => new openapi_1.OpenApiRequestBuilder('post', '/v1/workflow-instances', {
        body,
        headerParameters
    }),
    /**
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    updateV1WorkflowInstances: (body) => new openapi_1.OpenApiRequestBuilder('patch', '/v1/workflow-instances', {
        body
    }),
    /**
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    getV1WorkflowInstancesByWorkflowInstanceId: (workflowInstanceId, queryParameters, headerParameters) => new openapi_1.OpenApiRequestBuilder('get', '/v1/workflow-instances/{workflowInstanceId}', {
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    updateV1WorkflowInstancesByWorkflowInstanceId: (workflowInstanceId, body) => new openapi_1.OpenApiRequestBuilder('patch', '/v1/workflow-instances/{workflowInstanceId}', {
        pathParameters: { workflowInstanceId },
        body
    }),
    /**
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    getV1WorkflowInstancesAttributesByWorkflowInstanceId: (workflowInstanceId, headerParameters) => new openapi_1.OpenApiRequestBuilder('get', '/v1/workflow-instances/{workflowInstanceId}/attributes', {
        pathParameters: { workflowInstanceId },
        headerParameters
    }),
    /**
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    getV1WorkflowInstancesContextByWorkflowInstanceId: (workflowInstanceId) => new openapi_1.OpenApiRequestBuilder('get', '/v1/workflow-instances/{workflowInstanceId}/context', {
        pathParameters: { workflowInstanceId }
    }),
    /**
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    updateV1WorkflowInstancesContextByWorkflowInstanceId: (workflowInstanceId, body) => new openapi_1.OpenApiRequestBuilder('put', '/v1/workflow-instances/{workflowInstanceId}/context', {
        pathParameters: { workflowInstanceId },
        body
    }),
    /**
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    updateV1WorkflowInstancesContextByWorkflowInstanceId_1: (workflowInstanceId, body) => new openapi_1.OpenApiRequestBuilder('patch', '/v1/workflow-instances/{workflowInstanceId}/context', {
        pathParameters: { workflowInstanceId },
        body
    }),
    /**
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    getV1WorkflowInstancesErrorMessagesByWorkflowInstanceId: (workflowInstanceId) => new openapi_1.OpenApiRequestBuilder('get', '/v1/workflow-instances/{workflowInstanceId}/error-messages', {
        pathParameters: { workflowInstanceId }
    }),
    /**
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    getV1WorkflowInstancesExecutionLogsByWorkflowInstanceId: (workflowInstanceId, headerParameters) => new openapi_1.OpenApiRequestBuilder('get', '/v1/workflow-instances/{workflowInstanceId}/execution-logs', {
        pathParameters: { workflowInstanceId },
        headerParameters
    })
};
